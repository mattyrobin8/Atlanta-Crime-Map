...
def merge_export_df(df1,df2):
    ...
    crime_df_2020 = import_data(file_2020)
    match_geo_df = match_geo_df.append(crime_df_2020, ignore_index = True)
...
#Import files
file_2021 = r"C:\Users\matty\OneDrive\Politics\Mayor Felicia\Data\COBRA-2021.csv"
file_2020 = r"C:\Users\matty\OneDrive\Politics\Mayor Felicia\Data\crime_with_zips_no_2021.csv"

#Export files
export_match = r"C:\Users\matty\OneDrive\Politics\Mayor Felicia\Out\match_2021.csv"
...
def main():
    ...
    #Import Data
    crime_df_2021 = import_data(file_2021)
    crime_df_2021 = crime_df_2021[keep_cols]
    
    #Retrieve GeoData
    match_df = create_geo_file(crime_df_2021)

    #Merge the dataframes the export
    merge_export_df(crime_df_2021, match_df)
